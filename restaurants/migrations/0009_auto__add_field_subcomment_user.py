...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubComment.user'
        db.add_column(u'restaurants_subcomment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubComment.user'
        db.delete_column(u'restaurants_subcomment', 'user_id')
